...
**Jump to:** [Problem](#problem-statement) · [Naive approaches](#why-naive-approaches-fail) · [7 pieces](#core-solution-7-piece-progressive-release) · [Counterintuitive](#counter-intuitive-takeaway) · [Pitfalls](#three-production-traps)
